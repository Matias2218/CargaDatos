...
public class DataTrtNegocio {
	...
	private boolean validartDatos(String[] data, long cuenta) throws Exception {
		...
		try {
			...
			// Validar tipo de dato país de residencia
			} else if (!Util.esNumero(pais_reside)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de país de residencia");
				bitacora.add("213;" + cuenta + ";pais_reside;" + pais_reside + ";Tipo invalido de país de residencia, línea " + cuenta);

			// Validar tipo de dato país de origen
			} else if (!Util.esNumero(pais_origen)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de país de origen");
				bitacora.add("213;" + cuenta + ";pais_origen;" + pais_origen + ";Tipo invalido de país de origen, línea " + cuenta);

			// Validar tipo de dato motivo principal
			} else if (!Util.esNumero(motivo)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de motivo principal");
				bitacora.add("213;" + cuenta + ";motivo;" + motivo + ";Tipo invalido de motivo principal, línea " + cuenta);
			
			// Validar tipo de dato frontera
			} else if (!Util.esNumero(frontera)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de frontera");
				bitacora.add("213;" + cuenta + ";frontera;" + frontera + ";Tipo invalido de frontera, línea " + cuenta);

			// Validar tipo de dato valor total noches
			} else if (!Util.esDecimal(noches)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de valor total noches");
				bitacora.add("213;" + cuenta + ";noches;" + noches + ";Tipo invalido de valor total noches, línea " + cuenta);
			
			// Validar tipo de dato valor días turista
			} else if (!Util.esDecimal(dias)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de valor días turista");
				bitacora.add("213;" + cuenta + ";dias;" + dias + ";Tipo invalido de valor días turista, línea " + cuenta);

			// Validar tipo de dato valor gpdi
			} else if (!Util.esDecimal(gpdi)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de valor gpdi");
				bitacora.add("213;" + cuenta + ";gpdi;" + gpdi + ";Tipo invalido de valor gpdi, línea " + cuenta);
			
			// Validar tipo de dato valor gti
			} else if (!Util.esDecimal(gti)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de valor gti");
				bitacora.add("213;" + cuenta + ";gti;" + gti + ";Tipo invalido de valor gti, línea " + cuenta);
			
			// Validar tipo de dato valor divisas
			} else if (!Util.esDecimal(divisas)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de valor divisas");
				bitacora.add("213;" + cuenta + ";divisas;" + divisas + ";Tipo invalido de valor divisas, línea " + cuenta);
			
			// Validar tipo de dato factor expansión
			} else if (!Util.esDecimal(fe)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de valor factor expansión");
				bitacora.add("213;" + cuenta + ";fe;" + fe + ";Tipo invalido de valor factor expansión, línea " + cuenta);
