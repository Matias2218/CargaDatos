	...
	private boolean validartDatos(String[] data, long cuenta) throws Exception {
		...
		try {
			...
			// Validar tipo de dato tarjeta
				...
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de tarjeta");
				bitacora.add("213;" + cuenta + ";tarjeta;" + tarjeta + ";Tipo invalido de tarjeta, línea " + cuenta);
			
			// Validar tipo de dato país
			} else if (!Util.esNumero(pais)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de país");
				bitacora.add("213;" + cuenta + ";país;" + pais + ";Tipo invalido de país, línea " + cuenta);
			...
			// Validar tipo de dato modalidad
				...
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de modalidad");
				bitacora.add("213;" + cuenta + ";modalidad;" + modalidad + ";Tipo invalido de modalidad, línea " + cuenta);
			...
			// Validar tipo de dato número transacción
			} else if (!Util.esNumero(numeroTransaccion)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de número transacción");
				bitacora.add("213;" + cuenta + ";número transacción;" + numeroTransaccion + ";Tipo invalido de número transacción, línea " + cuenta);
				
			// Validar tipo de dato subrubro
			} else if (!Util.esNumero(subrubro)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de subrubro");
				bitacora.add("213;" + cuenta + ";subrubro;" + subrubro + ";Tipo invalido de subrubro, línea " + cuenta);
				
			// Validar tipo de dato rubro
			} else if (!Util.esNumero(rubro)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de rubro");
				bitacora.add("213;" + cuenta + ";rubro;" + rubro + ";Tipo invalido de rubro, línea " + cuenta);
