	...
	private boolean validartDatos(String[] data, long cuenta) throws Exception {
		...
		try {
			...
			// Validar tipo de dato peaje
				...
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de peaje");
				bitacora.add("213;" + cuenta + ";peaje;" + peaje + ";Tipo invalido de peaje, línea " + cuenta);
			
			// Validar tipo de dato tipo de vehículo 1
			} else if (!Util.esNumero(tv01)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de tipo de vehículo 1");
				bitacora.add("213;" + cuenta + ";tv01;" + tv01 + ";Tipo invalido de tipo de vehículo 1, línea " + cuenta);
			
			// Validar tipo de dato tipo de vehículo 3
			} else if (!Util.esNumero(tv03)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de tipo de vehículo 3");
				bitacora.add("213;" + cuenta + ";tv03;" + tv03 + ";Tipo invalido de tipo de vehículo 3, línea " + cuenta);
			
			// Validar tipo de dato tipo de vehículo 4
			} else if (!Util.esNumero(tv04)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de tipo de vehículo 4");
				bitacora.add("213;" + cuenta + ";tv04;" + tv04 + ";Tipo invalido de tipo de vehículo 4, línea " + cuenta);

			// Validar tipo de dato tipo de vehículo 5
			} else if (!Util.esNumero(tv05)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de tipo de vehículo 5");
				bitacora.add("213;" + cuenta + ";tv05;" + tv05 + ";Tipo invalido de tipo de vehículo 5, línea " + cuenta);

			// Validar tipo de dato tipo de vehículo 12
			} else if (!Util.esNumero(tv12)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de tipo de vehículo 12");
				bitacora.add("213;" + cuenta + ";tv12;" + tv12 + ";Tipo invalido de tipo de vehículo 12, línea " + cuenta);
