	...
	private boolean validartDatos(String[] data, long cuenta) throws Exception {
		...
		try {
			...
			// Validar tipo de dato feriado
				...
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de feriado");
				bitacora.add("213;" + cuenta + ";feriado;" + feriado + ";Tipo invalido de feriado, línea " + cuenta);
			...
			// Validar tipo de dato destino
				...
				bitacora.add("213;" + cuenta + ";destino;" + destino + ";Tipo invalido de destino, línea " + cuenta);
			
			// Validar tipo de dato tasa
			} else if (!Util.esDecimal(tasa)) {
				Util.setLog(archivoLog, "I", "Insertar Registros --> ERROR en línea " + cuenta, "tipo invalido de tasa");
				bitacora.add("213;" + cuenta + ";tasa;" + tasa + ";Tipo invalido de tasa, línea " + cuenta);
